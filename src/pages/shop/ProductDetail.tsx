...
export function ProductDetail() {
  ...
  useSEO({
    title: `${product?.name} - Buy Online at ₹${product?.price} | LavyaGlow`,
    description: `${product?.description} Order now from LavyaGlow. Free shipping on orders above ₹999.`,
    keywords: `${product?.name}, buy teddy candle, scented candle, soy wax candle`,
    image: product?.images?.length ? product.images[0] : '',
    url: `https://lavyaglow.com/products/${product?.id}`,
    canonical: `https://lavyaglow.com/products/${product?.id}`
  });
          ...
          <div className="product-detail__content">
            ...
            <div className="product-gallery">
              <div className="product-gallery__main">
                <ImageWithPlaceholder
                  src={
                    product.images[currentImageIndex] || "/default-candle.jpg"
                  }
                  alt={product.name}
                  width="100%"
                  placeholder="shimmer"
              ...
              <div className="product-info__header">
                ...
                <div className="product-info__pricing">
                  {discountPercentage > 0 ? (
                    ...
                    <span className="product-info__price-single">
                      ₹{product.discounted_price.toFixed(0)}
                    </span>
                  )}
                </div>
                        ...
                        <div key={set.id} className="set-item">
                          <div className="set-item__info">
                            ...
                            <span className="set-item__savings">
                              Save ₹
                              {(
                                set.actual_price - set.discounted_price
                              ).toFixed(0)}
                            </span>
                          </div>
                          <div className="set-item__pricing">
                            <span className="set-item__price-actual">
                              ₹{set.actual_price.toFixed(0)}
                            </span>
                            <span className="set-item__price-discounted">
                              ₹{set.discounted_price.toFixed(0)}
                            </span>
                            {setDiscount > 0 && (
                              <span className="set-item__discount">
                                ({setDiscount}% off)
                              </span>
                            )}
                          </div>
            ...
            <div className="product-purchase">
              ...
              <div className="bulk-info">
                ...
                <small>
                  We offer discounted pricing for large-volume purchases and can
