...
export function SocialMediaEmbed({ 
  ...
  // Don't render if no URL or invalid URL
  ...
  return (
    <div className="instagram-post-embed">
      {title && (
        <div className="instagram-post-embed__header">
          <h2>{title}</h2>
          <div className="instagram-post-embed__decoration">
            <svg 
              viewBox="0 0 24 24" 
      ...
      <div className="instagram-post-embed__wrapper">
        <InstagramEmbed 
          url={url} 
          width={width}
          captioned={captioned}
